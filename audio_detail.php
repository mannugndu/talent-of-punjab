...
<title>
talent of punjab audio talentedpunjab
</title>
...
<br>		
		<hr class="style18">
			...
			<tr>
			<td align="center">
			<img src="images/audio_thumb.png" width=100 height=80>
			</td>
			</tr>
			<tr>
			<td>
...
<div style="color:#3300b2;font-size:15px" align="center">
			 ...
			 <tr>
			 <td align="center">
			<form method="get" action="download_audio.php" name="da_form">
<input type="hidden" name="a_id" value="<?php echo $row[a_id] ?>">
			 <div align="center" style="color:white;font-weight:bold;font-size:20px;padding:5px;width:200px;background:#003300;cursor:pointer;border-radius:5px" onclick="da_form.submit()">
			 Download
			 </div>
			 </form>
			 </td>
			 ...
			 <tr>
			 <td align="center"><b>play here</b>
			 </td>
			 </tr>
			 <tr>
			 <td>
			<audio controls style="width:250px"> <source src="<?php echo "audios/".$row[name]; ?>" type="audio/mpeg">  </audio>
			 </td>
			 </tr>
			 <tr>
			 <td>
