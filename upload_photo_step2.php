 ...
 function enter_detect(e)
{
 ...
 {
	 if(upload_photo_step2_form.title.value=="")
	 {
 ...
 function next_check()
 {
	 ...
	 {
		 upload_photo_step2_form.submit();
	 }
 }
 </script>
</head>
...
<li class="completed">
 ...
 <li>  <span class="bubble"></span>Step 3.<span style="font-size:9px;">(select file)</span></li> 
  <li>  <span class="bubble"></span>Finish</li>
			...
			<hr class="style18">
			<div align="center" style="color:#3300b2;text-decoration:underline">Your Photo will be displayed by the given title</div>
			<form method="get" action="upload_photo_step3.php" name="upload_photo_step2_form">
			<table align="center">
			<tr>
			<td>
			</td>
