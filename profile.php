...
$query=mysqli_query($con,"select * from top_users where id='$login_active_id'");
...
<br>
		   ...
		   <?php
			...
			{?>
				...
				<div align="center" style="margin:auto;width:200px;font-weight:bold;"><div id="fields">Profile Detail</div></div>
				<hr class="style18">
			...
			{
?>
	<script language="javascript"> window.location.href="login.php?err=1"; </script>		
 <?php          	    
