...
//$query_photos=mysqli_query($con,"SELECT * FROM top_quotes");
...
user more quotes punjabi talent talent of punjab
</title>
...
$rows=mysql_num_rows(mysql_query("select * from top_quotes where user_id='$current_user'"));
...
if(isset($_GET['id']))
{
	...
	$query=mysql_query("select * from top_quotes where user_id='$current_user' LIMIT $start, $limit");
