...
$title=$title;
mysqli_query($con,"insert into top_videos(title,category,description,user_id,time)values('$title','$category','$description','$user_id','$upload_time')");
$login_active_id=$_SESSION['login_active_id'];
...
<li class="completed">
 ...
 <li id="finish">  <span class="bubble"></span>Finish</li> 
			...
			<tr>
			<td><div style="color:red" align="center">Extensions alloweded:- .mp4,.mov,.wmv,.avi,.mkv,.flv,.vob,.3gp</div>
			</td>
			</tr>
			<tr>
			<td>&nbsp;
            ...
            <input type="file" name="file1" id="file1" accept="video/*" onchange="file_check()">
			...
			<div align="center" id="p_bar" style="visibility:hidden">
