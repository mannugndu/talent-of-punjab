...
$id=$_GET['q_id'];
$qu=mysqli_query($con,"select * from top_quotes where q_id='$id'");
...
quotes punjabitalent talent of punjab talentedpunjab
</title>
...
?>
    <div class="row">
        ...
        <div class="col-md-8">
			...
			<div align="center" style="background:#d1d1ff;border-radius:10px;">
			<table>
			<tr>
			<td align="center" style="padding-top:15px;">
			
            <div style="background:#dcdcdc;width:250px;word-wrap:break-word;border-radius:5px;box-shadow:0px 4px 8px 0px black;">
			<?php
			$fileName_read_nm=$row[name]; 
